...
// 사용하기 전 : 숫자를 입력하는 과정에서도 동일한 연산을 수행함.
// 사용 후 : 특정의 결과값이 변경시에만 동작하도록 설정.
...
const AverageUseMemoTest = () => {
  ...
  // list 배열에 숫자 추가가 되면서, 그때, 연산이 수행이 됨.
  ...
  return (
    <div>
      ...
      {/* RDBMS 등의 외부 DB를 쓸때는 거기의 고유 id를 써야하고, 여기선 임의로 테스트하는 것이라 index로 key를 둔 것일뿐 */}
      <ul>
