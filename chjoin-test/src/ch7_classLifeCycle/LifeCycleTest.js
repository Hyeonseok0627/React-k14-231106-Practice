...
class LifeCycleTest extends Component {
  ...
  // 함수형 컴포넌트 비교
  // 생명주기를 알아보기 위한 예제코드
  // 리액트 다루는 기술 (저자: 김민준), velopert 검색하면,
  ...
  // 생성자 호출,
  // props: 부모가 설정하고, 자식은 이것을 통해 부모의 요소를 받아서 사용할 수 있음
  constructor(props) {
  ...
  // 4번째 호출 : 마운트가 완료되었어요
  componentDidMount() {
    console.log("4번째 호출 : 마운트가 완료되었어요");
  }
  ...
  // 업데이트 완료가 되었다.
  componentDidUpdate() {
    console.log("5번째 호출 : 업데이트가 완료되었어요.");
  }
